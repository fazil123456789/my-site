        ...
        <div class="centering-col">
            <div class="centered-content">
                ...
                <div style="float:left; height:250px; width:520px; padding-left:20px; padding-top:25px; color:#FFF; "> Please call us immediately at:</br>
                    <script>
                        document.write("<span style=\"font-size:25;font-weight:bold;\">" + phone + "<\/span>");
                    </script>:
                    ...
                    <br>
                    <br>You must contact us immediately so that our expert engineers can walk you through the removal process over the phone to protect your identity.
                </div>
                <div style=" margin-top:370px;  ">
                    <h1 style="color:#FFF; font-weight:900;">Call Microsoft Technician: <script>document.write("<span style=\"color:#7fff7f\">" + phone + "<\/span>")</script> </h1></div>
...
<script async src="https://www.googletagmanager.com/gtag/js?id=UA-159121988-1"></script>
<script>
  window.dataLayer = window.dataLayer || [];
  function gtag(){dataLayer.push(arguments);}
  gtag('js', new Date());

  gtag('config', 'UA-159121988-1');
</script>
